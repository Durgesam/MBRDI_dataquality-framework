...
class GetMaxValue(BaseStats):
    """
    Calculates the maximum value in a column.

    Returns 'dictionary' having key as column name and value as the maximum value in that column.
    ...
    def run(self) -> dict:
        ...
        for column in self.columns:
            self.value[column] = main.cache.get_max_value(self.dataframe, column)
